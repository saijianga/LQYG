...
- (void)showBadgeOnItemIndex:(int)index{
    ...
    badgeView.backgroundColor = [UIColor colorWithHexString:@"D02346"];
...
- (void)setBadgeValue:(NSInteger)value AtIndex:(NSInteger)index {
    ...
    badgeLabel.backgroundColor = [UIColor colorWithHexString:@"D02346"];
    badgeLabel.backgroundColor = [UIColor colorWithRed:255 / 255.0 green:59 / 255.0 blue:48 / 255.0 alpha:1];
    badgeLabel.tag = 999+index;
    badgeLabel.textColor = [UIColor whiteColor];
  //  badgeLabel.font = (__fontsize__);
