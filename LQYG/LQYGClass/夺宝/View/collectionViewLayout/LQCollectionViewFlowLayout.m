...
@implementation LQCollectionViewFlowLayout
- (instancetype)init {
    self = [super init];
    if (self) {
        _naviHeight = 64.0; //偏移量
        self.sectionInset = UIEdgeInsetsZero;
        //        self.itemSize = CGSizeMake(kScreenWidth/2.0, 95*kScreenWidth/150.0);
    }
    return self;
}
